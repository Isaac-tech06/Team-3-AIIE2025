...
* In conclusion, our best results came from a combination of a moderate image size such as 150x150, a sufficient model depth (20-30 layers), balanced train/test splits (80:20, 85:15) and a moderately small batch sizes (~11 -13). Trials with to few layers or large input sizes without deep models convincingly underperformed.
